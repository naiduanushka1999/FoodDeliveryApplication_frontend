...
import CreateDeliveryBoyButton from '../DeliveryBoys/CreateDeliveryBoyButton';
...
class DeliveryBoyDashboardOp extends React.Component{
    constructor(props){
        super(props);
        this.state={
            deliveryBoys:[]
    ...
    render(){
        ...
        return(
            <div className="adservices">
               ...
               <Link to="/adddeliveryboy" className="btn btn-primary btn btn-info"><h5>Add New Delivery Boy</h5></Link>&nbsp;
...
DeliveryBoyDashboardOp.propTypes={
...
export default connect(mapStateToProps,{getDeliveryBoys,deleteDeliveryBoy})(DeliveryBoyDashboardOp);